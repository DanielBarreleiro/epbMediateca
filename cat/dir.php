...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="cat uk-align-right">
      <hr class="top">
      <p class="p18" ><a href="../index.php">Categorias</a><span uk-icon="icon: chevron-double-right"></span> Direito</p>
      <div class="uk-margin">
    ...
    <div class="">
      <table class="uk-table uk-table-striped uk-table-responsive uk-float-right" style="width: 84%;">
          ...
          <?php
              ...
              $sql = "SELECT tblbooks.BookName,tblauthors.AuthorName,tblbooks.ISBNNumber,tblbooks.id as bookid from tblbooks JOIN tblauthors ON tblauthors.id = tblbooks.AuthorId WHERE CatId = 14";
